 ...
 */
metadata {
	definition (name: "VIRTUAL Opening Window Shade Curtain", namespace: "smartthings/testing", author: "SmartThings", runLocally: true, mnmn: "SmartThings", vid: "generic-window-shade") {
		capability "Actuator"
