 ...
 */
metadata {
    definition (name: "VIRTUAL Switch for Fan Vent", namespace: "andersonwembleyposavatz", author: "Anderson Wembley Posavatz", ocfDeviceType: "oic.d.fan", mnmn: "SmartThings", runLocally: true) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
