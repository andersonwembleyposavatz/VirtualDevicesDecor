 ...
 */
metadata {
	definition (name: "VIRTUAL DECOR Switch and Motion Sensor", namespace: "andersonwembleyposavatz", author: "Anderson W Posavatz", vid: "generic-motion", runLocally: true , executeCommandsLocally: true , ocfDeviceType: "x.com.st.d.sensor.motion", 
 ) {
		capability "Actuator"
		capability "Switch"
		capability "Refresh"
