 ...
 */
metadata {
    definition (name: "VIRTUAL DECOR Switch for Water", namespace: "andersonwembleyposavatz", author: "Anderson Wembley Posavatz", ocfDeviceType: "x.com.st.d.sensor.moisture", runLocally: true, minHubCoreVersion: '000.021.00001', executeCommandsLocally: true, mnmn: "SmartThings",) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
    ...
    tiles(scale: 2) {
        ...
        main(["water"])
        details(["switch", "explicitOn", "explicitOff", "battery"])
