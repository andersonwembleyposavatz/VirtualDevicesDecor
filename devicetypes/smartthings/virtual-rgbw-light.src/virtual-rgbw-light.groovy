...
metadata {
	definition (name: "VIRTUAL RGBW Light", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.light", mnmn: "SmartThings", vid: "generic-rgbw-color-bulb",  runLocally: true , executeCommandsLocally: true) {
