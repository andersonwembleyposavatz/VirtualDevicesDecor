 ...
 */
metadata {
	definition(name: "VIRTUAL 5-Scene Keypad DECOR", namespace: "smartthings", author: "SmartThings", mcdSync: true, mnmn: "SmartThings", ocfDeviceType: "x.com.st.d.remotecontroller", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: true) {
		capability "Actuator"
